...
public class BookingPage {
    ...
    public void clickBookNow() throws InterruptedException {
        ...
        driver.findElement(By.id("ctl14_firstName")).sendKeys("Marwa");
        driver.findElement(By.name("ctl14$lastName")).sendKeys("Essam");
        driver.findElement(By.id("ctl14_email")).sendKeys("m.e4658099@gmail.com");
        driver.findElement(By.cssSelector("#ctl14_mobile")).sendKeys("0113859575");

        Thread.sleep(1000);

        driver.findElement(By.id("ctl14_creditCard")).sendKeys("4863930018602819");
        driver.findElement(By.id("ctl14_creditcardName")).sendKeys("Marwa Essam Hassan");
        ...
        driver.findElement(By.id("ctl14_cvv")).sendKeys("968");
